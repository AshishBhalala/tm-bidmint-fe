  ...
  return (
    ...
    >
      ...
      <Form.Item
        ...
        name="ageOfEmployee"
        rules={[{ required: true, message: 'Please input Avg. Age of Employees!' }]}
      >
        <Select
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: 'Please input Sum insured amount ' }]}
      >
              <Radio.Group >
      ...
      <Form.Item name="remember1" valuePropName="checked" wrapperCol={{ offset: 8, span: 16 }}>
